...
<main>
        ...
        <article>
            ...
            <section id="courses">
                <div id="container">
                    <img src="imagens-oneup/imagem2.png" alt="">
                    <h1>Desenvolvedor Front-End</h1>
                    <p>Aprenda tudo sobre desenvolvimento de interfaces inteligentes e atrativas.</p>
                    <a href="cadastro.php">Inscreva-se agora</a>
                </div>
            </section>

            <button><h2><a href="cursos.php">Explorar Cursos</a></h2></button>
            ...
            <section>
                ...
                <h2>Como me inscrever para um curso?</h2>
